...
/**
 * @file
 * Job class for SimpleTest Legacy6 jobs on DrupalCI.
 */

namespace DrupalCI\Plugin\JobTypes\simpletestlegacy6;

use DrupalCI\Build\BuildBase;

/**
 * @PluginID("simpletestlegacy6")
 */

class SimpletestLegacy6Build extends BuildBase {
   ...
   */
  public $jobType = 'simpletestlegacy6';
  ...
  public $availableArguments = array(
    ...
    'DCI_CheckoutDir' => 'Defines the location to be used in creating the local copy of the codebase, to be mapped into the container as a container volume.  Default: /tmp/simpletestlegacy6-[random string]',
